...
function moveGemCache() {
  return fs.readdirSync(path.join(this.build_path,'ruby')).forEach(file => {
    return fs.moveSync(path.join(this.build_path,'ruby',file), path.join(this.build_path,'ruby/gems', file))
  });
}
